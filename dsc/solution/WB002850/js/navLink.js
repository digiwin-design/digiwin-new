// JavaScript Document
	...
	$('#navLink').load('navLink.htm', function() {
		...
		var navLiWidth = Math.floor((contentWidth - navLiNum - 1)/navLiNum) + 'px';
		$('#navLink .navLinks').css({width: navLiWidth});

		//判斷目前所在頁面        
		$('#navLink li a[href="' + URL_fileName + '"]').parents('.navLinks').addClass('selected');
	...
	//滑到下方諮詢單
	$("#navLink").on('click', 'a[href="#contact"]', function(){
