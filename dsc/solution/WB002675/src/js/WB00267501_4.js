...
httpVueLoader.register(Vue, 'components/WB00267501_4/hover-box.vue');
...
new Vue({
    el: 'main',
    components: {
        mobile: httpVueLoader('components/WB00267501_4/Mobile.vue'),
        desktop: httpVueLoader('components/WB00267501_4/Desktop.vue'),
    },
    computed: {
        isMobile() {
