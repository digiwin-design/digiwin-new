...
httpVueLoader.register(Vue, 'components/WB00267501_1/hover-box.vue');
...
new Vue({
    el: 'main',
    components: {
        mobile: httpVueLoader('components/WB00267501_1/Mobile.vue'),
        desktop: httpVueLoader('components/WB00267501_1/Desktop.vue'),
    },
    computed: {
        isMobile() {
