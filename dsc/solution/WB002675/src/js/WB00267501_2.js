...
httpVueLoader.register(Vue, 'components/WB00267501_2/hover-box.vue');
...
new Vue({
    el: 'main',
    components: {
        mobile: httpVueLoader('components/WB00267501_2/Mobile.vue'),
        desktop: httpVueLoader('components/WB00267501_2/Desktop.vue'),
    },
    computed: {
        isMobile() {
