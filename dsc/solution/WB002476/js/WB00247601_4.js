...
$(document).on('click','.iconsABC',function(){
	...
	var top3=$('.sectionF').offset().top-100;
	...
	if (i == 3 ) {
		...
		setTimeout(function() {
			var top5=$('.sectionF').offset().top-100;
			$('body,html').animate({'scrollTop':top5},400);
		},500)
		
	}else if (i == 2 ) {
      
        $('body,html').animate({'scrollTop':top2+100},400);
		setTimeout(function(){
			$('#changeDIV2').slideDown();	
		},450)
		setTimeout(function() {
			var top4=$('.sectionB').offset().top-100;
