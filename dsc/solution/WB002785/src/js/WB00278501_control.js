import '../sass/WB00278501_control/style.scss';
...
let app = new Vue({
    el: 'main',
    components: {
        mobile: httpVueLoader('components/WB00278501_control/mobile.vue'),
        desktop: httpVueLoader('components/WB00278501_control/desktop.vue'),
    },
    computed: {
        isMobile() {
