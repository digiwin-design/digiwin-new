import '../sass/WB00278501_produce/style.scss';
...
let app = new Vue({
    el: 'main',
    components: {
        mobile: httpVueLoader('components/WB00278501_produce/mobile.vue'),
        desktop: httpVueLoader('components/WB00278501_produce/desktop.vue'),
    },
    computed: {
        isMobile() {
