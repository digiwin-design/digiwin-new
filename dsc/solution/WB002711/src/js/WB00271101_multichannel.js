...
// httpVueLoader.register(Vue, 'components/WB00271101_multichannel/hover-box.vue');
        ...
        init() {
            this.$nextTick().then(() => {
                ...
                $('.fa-chevron-down').click(function () {
                    $('html, body').animate({ scrollTop: $('.issueGroup').offset().top + 'px' });
                ...
                $('#mainContent .group .list').click(function () {
                    var $this = $(this).index();
                    var _scrollTop = $('.issueGroup .issue')
                        .eq($this)
                        .offset().top;
                    $('html, body').animate({ scrollTop: _scrollTop + 'px' });
                });
                $('.jobProblem .txt10').hover(
                    function () {
                        var $this = $(this);
                        //$this.find('.txtLayer').stop().fadeOut();
                        $this
