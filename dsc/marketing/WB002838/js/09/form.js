...
function validateTel($telephone) {
    ...
    $("#msubmit").click(function(){
        ...
        function phContact() {
            ...
            requiLen > 0 ? requiLenFn() : phoneNumFn();
            function requiLenFn() {
                for(var i = 0; i < $('.required').length; i++){
                    ...
                    // Telephone.hasClass("required") == true ? phoneNum() : phoneNumFn() ;
                }
            }
            function phoneNumFn() {
